...
<div class="container-fluid">
        ...
        <ul style="float: left;list-style: outside none none;">
                <li style="float:left; width:150px; font-size:20px;">Name</li>
                <li style="float:left; width:150px; font-size:20px;">Phone</li>
                <li style="float:left; width:170px;font-size:20px;">Email</li>
                <li style="float:left; width:160px;font-size:20px;">College</li>
        </ul>
...
<?php foreach($result as $row): ?>
        ...
        <ul style="float: left;list-style: outside none none;">
            <li style="float:left; width:150px;"><?php echo $row->s_name; ?></li>
            <li style="float:left; width:150px;"><?php echo $row->s_phn; ?></li>
            <li style="float:left; width:170px;"><?php echo $row->s_email; ?></li>
            <li style="float:left; width:150px;"><?php echo $row->clg_name; ?></li>       	
        </ul>
        <?php endforeach; ?>
</div>
</body>
